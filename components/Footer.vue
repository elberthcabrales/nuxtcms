            ...
            <article class="notification media has-background-white">
              ...
              <div class="media-content">
                <div class="content">
                  ...
                  <p class="is-size-5 subtitle">The power of
                    <strong>Flexbox</strong> in a simple interface
                  </p>
                </div>
              </div>
            </article>
            ...
            <article class="notification has-background-white media">
              ...
              <div class="media-content">
                <div class="content">
                  ...
                  <p class="is-size-5 subtitle">The indispensable
                    <strong>form controls</strong>, designed for maximum clarity
                  </p>
                </div>
              </div>
            </article>
            ...
            <article class="notification has-background-white media">
              ...
              <div class="media-content">
                <div class="content">
                  ...
                  >Advanced multi-part components with lots of possibilities</p>
                </div>
              </div>
            </article>
          </div>
            ...
            <article class="notification has-background-white media">
              ...
              <div class="media-content">
                <div class="content">
                  ...
                  <p class="is-size-5 subtitle">An
                    <strong>easy-to-read</strong> naming system designed for humans
                  </p>
                </div>
              </div>
            </article>
            ...
            <article class="notification has-background-white media">
              ...
              <div class="media-content">
                <div class="content">
                  ...
                  <p class="is-size-5 subtitle">Design the
                    <strong>structure</strong> of your webpage with these CSS classes
                  </p>
                </div>
              </div>
            </article>
            ...
            <article class="notification has-background-white media">
              ...
              <div class="media-content">
                <div class="content">
                  ...
                  <p class="is-size-5 subtitle">Essential interface elements that only require a
      ...
      <div class="field is-grouped is-grouped-multiline">
        <div class="control">
          <div class="tags has-addons">
            <span class="tag is-dark">Colegio</span>
